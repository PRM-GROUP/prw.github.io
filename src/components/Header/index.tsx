...
import logoColor from '../../assets/LOGO PRW COLOR.svg';
  ...
  return (
    <header id="header" ref={headerRef} className={headerClass}>
      <nav className={`${styles.header} container`}>
        {/* Logo */}
        <Link to="/#home"><img className={styles.logo} src={logoColor} alt="PRW GRAVAÇÕES" /></Link>
        ...
        <div className={styles.menu}>
          ...
          <Link smooth className={`${isLinkActive('prm_tecprint') ? styles.active : ''}`} to="/#prm_tecprint">PRM TecPrint</Link>
        ...
        <div className={mobileMenuClass}>
          ...
          <Link smooth className={`${isLinkActive('prm_tecprint') ? styles.active : ''}`} to="/#prm_tecprint" onClick={handleMobileLinkClick}>PRM TecPrint</Link>
