...
import PRM_Logo from '../../assets/LOGO PRM.svg';
...
const [activeLink, setActiveLink] = useState<string>('');
      ...
      <section className={styles.main__PRW} id='prm_tecprint' ref={sectionsRef.prm_tecprint}>
        <div className={`${styles.container__prw} container`}>
          ...
          <div className={styles.text__prw}>
            ...
            <a href="https://prm-group.github.io/prm.github.io/#home" className={styles.button}target='_blanck'>Conheça a PRM TECPRINT</a>
          </div>
        </div>
      </section>
      ...
      <section id='contact' ref={sectionsRef.contact}>
        <div className={`${styles.container__contact} container`} >
          ...
          <div className={styles.contact__text}>
            ...
            <p>Entre em contato com a PRW Gravações, queremos tirar suas dúvidas.</p>
  ...
  ' target="_blank"><img src={WhatsAppWhite} alt="WhatsApp Icon"/> Entrar em contato</Link>
          </div>
